...
@Parcelize
internal actual class CreationTaskScreen actual constructor() : Screen, ComposableScreen {

    @Composable
    override fun Content(componentContext: ComponentContext) {
        val viewModel = CreationTaskUiComponent(componentContext).viewModel
        CreationTaskComposable(viewModel)
    }
}