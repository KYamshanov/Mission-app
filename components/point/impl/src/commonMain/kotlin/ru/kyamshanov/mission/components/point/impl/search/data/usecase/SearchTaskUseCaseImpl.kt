package ru.kyamshanov.mission.components.point.impl.search.data.usecase
...
import ru.kyamshanov.mission.components.point.impl.search.data.model.TaskPriorityDto
import ru.kyamshanov.mission.components.point.impl.search.data.model.TaskPriorityDto.*
import ru.kyamshanov.mission.components.point.impl.search.data.model.TaskStatusDto
import ru.kyamshanov.mission.components.point.impl.search.data.model.TaskStatusDto.*
...
private fun AttachedTasksResponseDto.toDomain(): List<TaskSlim> = this.items.map {
    TaskSlim(
        it.id, it.title, it.priority.toDomain(), it.status.toDomain()
    )
}
