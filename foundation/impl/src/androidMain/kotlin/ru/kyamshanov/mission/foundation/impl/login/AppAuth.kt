...
internal object AppAuth {
    ...
    private object AuthConfig {
        const val AUTH_URI = "https://kyamshanov.ru:9000/oauth2/authorize"
        const val TOKEN_URI = "https://kyamshanov.ru:9000/oauth2/token"
        const val END_SESSION_URI = "https://kyamshanov.ru:9000/oauth2/logout"
        const val RESPONSE_TYPE = ResponseTypeValues.CODE
        const val SCOPE = "point"

        const val CLIENT_ID = "desktop-client"
        const val CLIENT_SECRET = "secret"
        const val CALLBACK_URL = "https://kyamshanov.ru:8080/desktop/authorized"
